      ...
      <View style={styles.content}>
        <View style={styles.topCard}>
          <View style={styles.avatar}>
            <Ionicons name="person" size={28} color={MedsTheme.colors.primaryDark} />
          </View>
          <Text style={styles.name}>MediTime User</Text>
          <Text style={styles.role}>Nhắc lịch uống thuốc mỗi ngày</Text>
        </View>

        <Pressable style={styles.rowButton} onPress={() => router.push('/schedule')}>
          <Ionicons name="calendar-outline" size={18} color={MedsTheme.colors.primaryDark} />
        ...
        <Pressable style={styles.rowButton} onPress={() => router.push('/history')}>
          <Ionicons name="time-outline" size={18} color={MedsTheme.colors.primaryDark} />
        ...
        <Pressable style={styles.sosCard} onPress={() => router.push('/sos')}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.sosText}>Mở nhanh SOS và cuộc gọi emergency</Text>
          </View>
